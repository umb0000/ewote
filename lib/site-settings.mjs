const fallbackVideo = 'https://res.cloudinary.com/demo/video/upload/q_auto/dog.mp4';
const fallbackPoster = 'https://res.cloudinary.com/demo/video/upload/so_0,w_1600,q_auto/dog.jpg';

export const defaultSiteSettings = Object.freeze({
  homeVideo: fallbackVideo,
  homePoster: fallbackPoster,
  homeIntroLines: ['𝖤𝖳𝖤𝖱𝖭𝖠𝖫 𝖶𝖨𝖲𝖣𝖮𝖬 𝖮𝖭 𝖳𝖧𝖤 𝖤𝖠𝖱𝖳𝖧'],
  homeServiceLine: 'FILM, IMAGE & CREATIVE DIRECTION',
  featuredProject: undefined,
  workVideo: fallbackVideo,
  workPoster: fallbackPoster,
  workEyebrow: '',
  workTitle: 'WORK',
